    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2">Gérer les matières</h3>
          <p class="text-sm text-gray-600">Matières et coefficients</p>
        </router-link>
        ...
        >
          ...
          <p class="text-sm text-gray-600">Transactions et suivi financier</p>
        </router-link>
        ...
        >
          ...
          <p class="text-sm text-gray-600">Planification et contrôle budgétaire</p>
        </router-link>
      </div>
    </div>
  </div>
